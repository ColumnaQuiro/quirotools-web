...
<template>
  <cq-layout-section>
    ...
    <div class="text-xl font-medium pb-3 pt-6">
      LEY DE LOS SERVICIOS DE LA SOCIEDAD DE LA INFORMACIÓN (LSSI)
    </div>

    Léa Guido, con NIF: Y7115191V, responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSICE), así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.
    <br><br>
    Toda persona que acceda a este sitio web asume el papel de usuario, comprometiéndose a la observancia y cumplimiento riguroso de las disposiciones aquí dispuestas, así como a cualquier otra disposición legal que fuera de aplicación.
    <br><br>
    Léa Guido se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente con la publicación en el sitio web de TU EMPRESA, S.L
    <div class="text-xl font-medium pb-3 pt-6">
      1. DATOS IDENTIFICATIVOS
    </div>
    <ul class="list-disc">
      <li>
        Persona física: Léa Guido
      </li>
      <li>
        Nombre comercial: Chiro-tools
      </li>
      <li>
        NIF: Y7115191V
      </li>
      <li>
        Domicilio: Calle del Cardenal Benlloch 63, 3-5, 46920, Mislata
      </li>
      <li>
        E-mail: admin@chiro-tools.com
      </li>
    </ul>
